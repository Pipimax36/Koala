export default {
  redesign: {
    ...
    tunMode: '虚拟网卡模式',
    switchMode: '切换代理模式',
    switchModeHint: '切换会短暂中断连接，成功后恢复启用状态。失败时将尝试恢复原配置。',
    operationFailed: '操作失败',
    recoveryFailed: '恢复未完成，请检查内核和代理设置',
    outboundMode: '出站模式',
    rule: '规则',
    global: '全局',
    direct: '直连',
    ...
    enabled: '代理已启用',
    disabled: '代理已停用',
    coreUnavailable: '内核状态不可用',
    coreUnavailableHint: '无法读取内核状态，请刷新或检查内核。',
    refreshStatus: '刷新状态',
    unknown: '未知',
    loading: '正在加载…',
    enableProxy: '启用代理',
    disableProxy: '停用代理',
    tunHint: '通过虚拟网卡接管流量，适用于不遵循系统代理的应用。',
    defaultHint: '使用默认代理方式，是否写入系统代理遵循已有设置。',
    portDisabled: '混合端口已禁用，请先在内核设置中配置端口。',
    upload: '上传',
    download: '下载',
    total: '累计',
    currentNode: '当前节点',
    noNode: '暂无可用节点',
    chooseNode: '选择节点',
    outboundHint: '决定请求按规则分流、全部代理或全部直连。',
    currentProfile: '当前订阅',
    updateSubscription: '更新订阅',
    usedTraffic: '已用流量',
    notProvided: '未提供',
    connectivityHint: '代理已启用表示代理功能已开启，不代表互联网连通性已验证。'
  },
  ...
  profile: {
    ...
    editRules: {
      ...
      saveError: '保存规则失败',
      loadError: '规则加载失败',
      loadErrorHint: '已禁用保存，以免覆盖已添加的规则。可使用 YAML 编辑器手动修改文件。',
      saveBlocked: '无法保存：规则加载失败',
